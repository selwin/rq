...
class Queue(object):
    ...
    def schedule_at(self, *args, **kwargs):
        ...
        scheduler = Scheduler(self.name, connection=self.connection)
        return scheduler.enqueue_at(*args, **kwargs)

    def schedule_in(self, *args, **kwargs):
        from .scheduler import Scheduler
        scheduler = Scheduler(self.name, connection=self.connection)
        return scheduler.enqueue_in(*args, **kwargs)
